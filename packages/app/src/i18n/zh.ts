...
export const dict = {
  ...
  "dandelion.starter.pptx.query1": "使用 pptx skill，帮我创建一份 .pptx 演示文稿并保存到桌面。主题：一家做智能文档处理的 AI 创业公司「NeuralFlow」的投资人路演，共 10 页。使用深海军蓝主题（#1a1a2e）搭配青绿色强调（#16c79a）。页面安排：1）标题页，标语「文档，智能解码」；2）痛点——企业每年花 120 亿美元在手动文档处理上；3）解决方案及产品截图占位；4）工作原理——3 步技术流程图；5）市场规模——240 亿美元 TAM 细分；6）商业模式——按量计费的阶梯定价；7）增长数据——50 家企业客户，月处理 300 万份文档；8）团队——3 位联合创始人的 AI/企业背景；9）18 个月路线图及关键里程碑；10）融资需求——500 万美元 A 轮用于市场扩张。每页附上演讲者备注，设计要精致美观。",
