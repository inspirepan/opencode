...
export const dict = {
  ...
  "dandelion.starter.design.title": "平面设计",
  "dandelion.starter.design.description": "创建插画、标志、图标和视觉素材",
  "dandelion.starter.design.example1": "为一个名为 Dawnbrew 的咖啡品牌设计极简风格 Logo，使用大地色系",
  "dandelion.starter.design.example2": "创建一组 4 个扁平风格图标：日历、通知、设置、个人资料",
  "dandelion.starter.design.example3": "生成一张社交媒体横幅（1200x630），科技大会主题，未来感风格",
