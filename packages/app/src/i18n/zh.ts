...
export const dict = {
  ...
  "dandelion.starter.data.title": "数据处理",
  "dandelion.starter.data.description": "解析、转换和分析结构化数据与文档",
  "dandelion.starter.data.example1": "读取 sales.csv，生成按月汇总的营收报表，并用 HTML 画出趋势图",
  "dandelion.starter.data.example2": "提取这个 PDF 中的所有表格，分别保存为独立的 CSV 文件",
  "dandelion.starter.data.example3": "合并这三个 JSON 文件，按 id 字段去重，输出一份干净的文件",
