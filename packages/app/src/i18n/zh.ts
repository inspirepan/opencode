...
export const dict = {
  ...
  "dandelion.starter.pptx.query1": "帮我做一份创业公司的投资人路演 PPT，大概 10 页左右。",
  "dandelion.starter.pptx.label2": "读取并总结一份 PPT 的核心内容",
  "dandelion.starter.pptx.query2": "我有一份 PPT，帮我阅读并总结核心内容。",
  "dandelion.starter.pptx.label3": "用最新数据替换 PPT 中的旧内容",
  "dandelion.starter.pptx.query3": "帮我用最新数据更新一份季度业务回顾 PPT。",
  ...
  "dandelion.starter.xlsx.query1": "帮我做一份月度家庭预算表格，要有公式自动计算和图表展示。",
  "dandelion.starter.xlsx.label2": "分析销售表格并生成透视汇总",
  "dandelion.starter.xlsx.query2": "我有一份销售数据表格，帮我做专业的分析和透视汇总。",
  "dandelion.starter.xlsx.label3": "制作带下拉菜单和自动汇总的报销表",
  "dandelion.starter.xlsx.query3": "帮我做一份团队报销记录表，要有下拉菜单和自动汇总。",
  ...
  "dandelion.starter.files.query1": "帮我扫描 ~/Downloads 文件夹，找出重复文件并清理。",
  "dandelion.starter.files.label2": "把桌面文件按类型自动归类到文件夹",
  "dandelion.starter.files.query2": "帮我把桌面上的文件按类型自动整理到对应文件夹里。",
  "dandelion.starter.files.label3": "读取照片拍摄信息并批量重命名",
  "dandelion.starter.files.query3": "帮我读取 ~/Pictures/Album 里照片的 EXIF 信息，按日期和地点批量重命名。",
  ...
  "dandelion.starter.infographic.query1": "帮我做一张水循环的科普信息图，面向初中课堂使用。",
  "dandelion.starter.infographic.label2": "把一篇文章转化为可视化信息图",
  "dandelion.starter.infographic.query2": "我有一篇文章想转化成信息图，方便在社交媒体分享。",
  "dandelion.starter.infographic.label3": "创建互联网发展史时间线长图",
  "dandelion.starter.infographic.query3": "帮我做一张互联网发展史的时间线信息图，从 ARPANET 到 AI 时代。",
  ...
  "dandelion.starter.poster.query1": "帮我给一款高端补水精华液做一张小红书风格的产品海报。",
  "dandelion.starter.poster.label2": "生成科技感数码产品淘宝主图",
  "dandelion.starter.poster.query2": "帮我给一款无线降噪耳机做一张科技感的淘宝主图。",
  "dandelion.starter.poster.label3": "设计带促销价格的双十一活动海报",
  "dandelion.starter.poster.query3": "帮我设计一张双十一羽绒服促销海报，要有原价和活动价。",
