...
export const dict = {
  ...
  "dandelion.starter.webpage.title": "网站制作",
  "dandelion.starter.webpage.description": "设计和开发网站，从静态页面到带后端的完整应用",
  "dandelion.starter.webpage.label1": "为我的产品做一个营销落地页",
  "dandelion.starter.webpage.query1": "使用 create-web-site skill，帮我制作一个精美的产品营销落地页。",
  "dandelion.starter.webpage.label2": "帮我设计一个个人作品集网站",
  "dandelion.starter.webpage.query2": "使用 create-web-site skill，帮我制作一个个人作品集网站。",
  "dandelion.starter.webpage.label3": "为我的餐馆制作一个网站",
  "dandelion.starter.webpage.query3": "使用 create-web-site skill，帮我的餐馆做一个网站，包含餐厅介绍、菜单展示和在线预定系统。",
