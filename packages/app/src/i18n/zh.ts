...
export const dict = {
  ...
  "dandelion.starter.webpage.title": "网页制作",
  "dandelion.starter.webpage.description": "设计和开发精美的网页、落地页和个人站点",
  "dandelion.starter.webpage.label1": "为我的产品做一个营销落地页",
  "dandelion.starter.webpage.query1": "使用 web-page skill，帮我制作一个精美的产品营销落地页。",
  "dandelion.starter.webpage.label2": "帮我设计一个个人作品集网站",
  "dandelion.starter.webpage.query2": "使用 web-page skill，帮我制作一个个人作品集网站。",
  "dandelion.starter.webpage.label3": "把我的内容做成一个互动展示页",
  "dandelion.starter.webpage.query3": "使用 web-page skill，帮我制作一个有互动效果的数据展示页。",
