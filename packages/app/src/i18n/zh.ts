...
export const dict = {
  ...
  "dandelion.starter.writing.example2": "将以下会议纪要翻译成正式英文，保留原有结构",
  "dandelion.starter.writing.example3": "重写这段产品描述，使其更简洁，更能吸引企业客户",
  "dandelion.starter.analysis.title": "分析",
  "dandelion.starter.analysis.description": "解读信息、对比方案、提炼洞察",
  "dandelion.starter.analysis.example1": "对比 React、Vue 和 Svelte 各自的优缺点，适用于中型内部工具场景",
  "dandelion.starter.analysis.example2": "总结这篇 3000 字研究论文的核心论点，并列出待解决的问题",
  "dandelion.starter.analysis.example3": "审阅这份合同草稿，标出对买方不利的条款",
  "dandelion.starter.brainstorm.title": "头脑风暴",
  "dandelion.starter.brainstorm.description": "探索创意、规划策略、梳理思路",
  "dandelion.starter.brainstorm.example1": "我要为小型餐厅做一个 SaaS 产品，帮我想 10 个营销渠道的点子",
  "dandelion.starter.brainstorm.example2": "有哪 5 种创新方式可以引导新用户上手，而不需要传统教程？",
  "dandelion.starter.brainstorm.example3": "帮我制定一个 3 个月的学习计划，准备 AWS 解决方案架构师考试",

  "dandelion.starter.pptx.title": "演示文稿",
  "dandelion.starter.pptx.description": "创作、编辑和分析 PowerPoint 演示文稿",
  "dandelion.starter.pptx.example1": "为一个 AI 创业公司制作 10 页路演 PPT，使用深色主题搭配青绿色点缀",
  "dandelion.starter.pptx.example2": "读取 my-presentation.pptx，逐页总结每张幻灯片的核心要点",
  "dandelion.starter.pptx.example3": "更新 Q3 报告的幻灯片：用 revenue.csv 中的最新数据替换所有营收数字",
  "dandelion.starter.docx.title": "Word 文档",
  "dandelion.starter.docx.description": "创建、编辑和排版专业 Word 文档",
  "dandelion.starter.docx.example1": "创建一份专业的项目提案，包含目录、标题层级和页码",
  "dandelion.starter.docx.example2": "读取 my-report.docx，将执行摘要改写得更简洁有力",
  "dandelion.starter.docx.example3": "创建一份正式的商务信函模板，包含公司抬头、日期和签名栏",
  "dandelion.starter.xlsx.title": "电子表格",
  "dandelion.starter.xlsx.description": "创建、编辑和分析带公式的 Excel 表格",
  "dandelion.starter.xlsx.example1": "创建一份家庭月度预算表，包含分类、合计公式和汇总图表",
  "dandelion.starter.xlsx.example2": "读取 sales-data.xlsx，新增一个数据透视汇总页，按区域和季度展示营收",
  "dandelion.starter.xlsx.example3": "做一个费用记录表，自动计算税额、分类合计，并设置条件格式高亮",
  ...
  "dandelion.starter.files.example1": "扫描我的 Downloads 文件夹，找出所有重复的文件，保留最新版本",
  "dandelion.starter.files.example2": "请访问我桌面文件夹，按文件类型（文档、图片、视频、表格等）自动分类整理到不同的子文件夹中",
  "dandelion.starter.files.example3": "请读取相册目录下照片的 EXIF 信息，获取拍摄地点和日期，统一重命名为 YY-MM-DD_地点_序号.jpg",
  "dandelion.starter.infographic.title": "信息图",
  "dandelion.starter.infographic.description": "将任何主题转化为精美的可视化信息图",
  "dandelion.starter.infographic.example1": "制作一张水循环的信息图，使用手绘风格",
  "dandelion.starter.infographic.example2": "把这篇关于健康饮食习惯的文章做成对比式信息图",
  "dandelion.starter.infographic.example3": "做一张互联网发展史的时间线信息图，赛博朋克霓虹风格",

  "dandelion.starter.photo.title": "照片生成",
  "dandelion.starter.photo.description": "生成逼真的照片、人像和场景",
  "dandelion.starter.photo.example1": "生成一张产品照：哑光黑色陶瓷杯放在大理石台面上，清晨光线",
  "dandelion.starter.photo.example2": "创建一张专业证件照，柔和渐变背景，影棚布光",
  "dandelion.starter.photo.example3": "生成一个温馨咖啡馆内景：木桌、暖色灯光、窗外下着雨",
  "dandelion.starter.poster.title": "电商广告海报",
  "dandelion.starter.poster.description": "生成电商产品主图、广告海报和促销视觉",
  "dandelion.starter.poster.example1": "为这款精华液生成一张小红书风格的产品海报，柔粉色调，生活美学感",
  "dandelion.starter.poster.example2": "为这款无线耳机做一张淘宝主图，科技风，深色背景加光效",
  "dandelion.starter.poster.example3": "设计一张双十一促销横幅海报，展示这件羽绒服的原价和活动价，活力促销风格",
  "dandelion.starter.remix.title": "图片编辑",
  "dandelion.starter.remix.description": "变换风格、重新处理和增强现有图片",
  "dandelion.starter.remix.example1": "将这张照片转换为吉卜力动画风格，保持原有构图",
  "dandelion.starter.remix.example2": "去除这张产品图的背景，替换为纯白底色",
  "dandelion.starter.remix.example3": "将这张低分辨率图片放大 4 倍，同时保留细节、减少噪点",
