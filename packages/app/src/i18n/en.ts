export const dict = {
  ...
  "dandelion.starter.design.title": "Graphic Design",
  "dandelion.starter.design.description": "Create illustrations, logos, icons, and visual assets",
  "dandelion.starter.design.example1": "Design a minimalist logo for a coffee brand called 'Dawnbrew', using earth tones",
  "dandelion.starter.design.example2": "Create a set of 4 flat-style icons for: calendar, notification, settings, profile",
  "dandelion.starter.design.example3": "Generate a social media banner (1200x630) for a tech conference, futuristic style",
