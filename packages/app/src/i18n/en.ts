export const dict = {
  ...
  "dandelion.starter.pptx.query1": "Help me create an investor pitch deck for a startup, about 10 slides.",
  "dandelion.starter.pptx.label2": "Read and summarize the key points of a PPT",
  "dandelion.starter.pptx.query2": "I have a PPT file -- please read through it and summarize the key points.",
  "dandelion.starter.pptx.label3": "Replace outdated data in a PPT with new numbers",
  "dandelion.starter.pptx.query3": "Help me update a quarterly business review PPT with the latest data.",
  ...
  "dandelion.starter.xlsx.query1": "Create a monthly household budget spreadsheet with formulas and charts.",
  "dandelion.starter.xlsx.label2": "Analyze a sales spreadsheet and generate pivot summaries",
  "dandelion.starter.xlsx.query2": "I have a sales data spreadsheet -- please analyze it and create pivot summaries.",
  "dandelion.starter.xlsx.label3": "Build an expense tracker with dropdowns and auto-totals",
  "dandelion.starter.xlsx.query3": "Build a team expense tracker with dropdown menus and auto-calculated totals.",
  ...
  "dandelion.starter.files.query1": "Scan my ~/Downloads folder, find duplicate files and help me clean them up.",
  "dandelion.starter.files.label2": "Sort desktop files into folders by file type",
  "dandelion.starter.files.query2": "Sort all files on my Desktop into folders organized by file type.",
  "dandelion.starter.files.label3": "Batch-rename photos using EXIF date and location",
  "dandelion.starter.files.query3": "Read EXIF data from photos in ~/Pictures/Album and batch-rename them by date and location.",
  ...
  "dandelion.starter.infographic.query1": "Create an educational infographic about the water cycle, suitable for a middle school classroom.",
  "dandelion.starter.infographic.label2": "Turn an article into a visual infographic",
  "dandelion.starter.infographic.query2": "I have an article I'd like turned into a visual infographic for social media sharing.",
  "dandelion.starter.infographic.label3": "Create an internet history timeline graphic",
  "dandelion.starter.infographic.query3": "Create a timeline infographic of Internet history, from ARPANET to the AI era.",
  ...
  "dandelion.starter.poster.query1": "Create a Xiaohongshu-style product poster for a premium hydrating facial serum.",
  "dandelion.starter.poster.label2": "Generate a tech product e-commerce hero image",
  "dandelion.starter.poster.query2": "Design a tech-style e-commerce main image for wireless noise-cancelling headphones.",
  "dandelion.starter.poster.label3": "Design a sale banner with promo pricing",
  "dandelion.starter.poster.query3": "Design a Double 11 promotional poster for a down jacket with original and sale prices.",
