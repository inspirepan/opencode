export const dict = {
  ...
  "dandelion.starter.webpage.title": "Web Sites",
  "dandelion.starter.webpage.description": "Design and build websites, from static pages to full-stack apps with backend",
  "dandelion.starter.webpage.label1": "Create a marketing landing page for my product",
  "dandelion.starter.webpage.query1": "Use the create-web-site skill to create a polished product marketing landing page.",
  "dandelion.starter.webpage.label2": "Design a personal portfolio website for me",
  "dandelion.starter.webpage.query2": "Use the create-web-site skill to build a personal portfolio website.",
  "dandelion.starter.webpage.label3": "Build a website for my restaurant",
  "dandelion.starter.webpage.query3": "Use the create-web-site skill to build a website for my restaurant, including an about section, menu showcase, and online reservation system.",
