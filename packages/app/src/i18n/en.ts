export const dict = {
  ...
  "dandelion.starter.writing.example2": "Translate the following meeting notes into formal English, keeping the original structure",
  "dandelion.starter.writing.example3": "Rewrite this product description to be more concise and appealing to enterprise buyers",
  ...
  "dandelion.starter.analysis.example1": "Compare the pros and cons of React, Vue, and Svelte for a mid-size internal tool",
  "dandelion.starter.analysis.example2": "Summarize the key arguments in this 3000-word research paper and list open questions",
  "dandelion.starter.analysis.example3": "Review this contract draft and flag any clauses that are unfavorable to the buyer",
  ...
  "dandelion.starter.brainstorm.example1": "I'm launching a SaaS for small restaurants. Help me brainstorm 10 marketing channel ideas",
  "dandelion.starter.brainstorm.example2": "What are 5 creative ways to onboard new users without a traditional tutorial?",
  "dandelion.starter.brainstorm.example3": "Help me design a 3-month study plan to prepare for the AWS Solutions Architect exam",
  ...
  "dandelion.starter.pptx.example1": "Create a 10-slide pitch deck for an AI startup, using a dark theme with teal accents",
  "dandelion.starter.pptx.example2": "Read my-presentation.pptx and summarize the key points from each slide",
  "dandelion.starter.pptx.example3": "Update the Q3 report slides: replace all revenue figures with the latest data from revenue.csv",
  ...
  "dandelion.starter.docx.example1": "Create a professional project proposal with a table of contents, headings, and page numbers",
  "dandelion.starter.docx.example2": "Read my-report.docx and rewrite the executive summary to be more concise",
  "dandelion.starter.docx.example3": "Create a formal business letter template with company letterhead, date, and signature block",
  ...
  "dandelion.starter.xlsx.example1": "Create a monthly household budget spreadsheet with categories, formulas for totals, and a summary chart",
  "dandelion.starter.xlsx.example2": "Read sales-data.xlsx and add a pivot summary sheet showing revenue by region and quarter",
  "dandelion.starter.xlsx.example3": "Build an expense tracker with auto-calculated tax, category totals, and conditional formatting",
  ...
  "dandelion.starter.files.example1": "Scan my Downloads folder, find all duplicates, and keep only the newest version of each",
  "dandelion.starter.files.example2": "Sort files on my Desktop into subfolders by type: documents, images, videos, spreadsheets",
  "dandelion.starter.files.example3": "Read EXIF data from photos in my album folder, then rename them as YYYY-MM-DD_location_seq.jpg",
  ...
  "dandelion.starter.infographic.example1": "Create an infographic explaining the water cycle, using a hand-drawn craft style",
  "dandelion.starter.infographic.example2": "Turn this article about healthy eating habits into a visual comparison infographic",
  "dandelion.starter.infographic.example3": "Make a timeline infographic of the history of the Internet, cyberpunk neon style",
  ...
  "dandelion.starter.photo.example1": "Generate a product photo of a matte black ceramic mug on a marble countertop, morning light",
  "dandelion.starter.photo.example2": "Create a professional headshot portrait with a soft gradient background, studio lighting",
  "dandelion.starter.photo.example3": "Generate a cozy cafe interior scene: wooden tables, warm lighting, rain outside the window",
  ...
  "dandelion.starter.poster.example1": "Generate a Xiaohongshu-style product poster for this skincare serum, soft pink tones, lifestyle feel",
  "dandelion.starter.poster.example2": "Create a Taobao main image for this wireless headphone, tech style with dark background and glow effects",
  "dandelion.starter.poster.example3": "Design a Double 11 promotional banner for this down jacket, show original and sale price, energetic mood",
  ...
  "dandelion.starter.remix.example1": "Convert this photo to a Studio Ghibli animation style, keep the original composition",
  "dandelion.starter.remix.example2": "Remove the background from this product image and replace it with a clean white backdrop",
  "dandelion.starter.remix.example3": "Upscale this low-resolution image to 4x while preserving detail and reducing noise",
