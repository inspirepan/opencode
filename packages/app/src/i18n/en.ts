export const dict = {
  ...
  "dandelion.starter.data.title": "Data Processing",
  "dandelion.starter.data.description": "Parse, transform, and analyze structured data and documents",
  "dandelion.starter.data.example1": "Read sales.csv and generate a monthly revenue summary with a trend chart in HTML",
  "dandelion.starter.data.example2": "Extract all tables from this PDF and save them as separate CSV files",
  "dandelion.starter.data.example3": "Merge these three JSON files, remove duplicates by the 'id' field, and output a clean file",
