...
export const starters: Record<DandelionMode, Starter[]> = {
  ...
  agent: [
    ...
    },
    {
      id: "data",
      icon: "code",
      title: "dandelion.starter.data.title",
      description: "dandelion.starter.data.description",
      examples: [
        "dandelion.starter.data.example1",
        "dandelion.starter.data.example2",
        "dandelion.starter.data.example3",
      ],
    },
  ],
  image: [
