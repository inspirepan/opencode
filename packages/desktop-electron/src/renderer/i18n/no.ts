export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Dandelion er lastet ned. Vil du installere den og starte på nytt?",
