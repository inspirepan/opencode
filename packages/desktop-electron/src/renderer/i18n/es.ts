export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Dandelion. ¿Quieres instalarla y reiniciar?",
