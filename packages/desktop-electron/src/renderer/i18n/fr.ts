export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Dandelion a été téléchargée. Voulez-vous l'installer et redémarrer ?",
