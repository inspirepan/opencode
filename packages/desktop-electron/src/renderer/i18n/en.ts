export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Coco Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Coco Desktop has been downloaded, would you like to install it and relaunch?",
