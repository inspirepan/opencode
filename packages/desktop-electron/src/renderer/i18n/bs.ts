export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Dandelion-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Dandelion-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
