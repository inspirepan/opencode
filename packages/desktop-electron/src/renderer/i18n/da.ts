export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Dandelion er blevet downloadet. Vil du installere den og genstarte?",
