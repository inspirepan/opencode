export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Dandelion. Czy chcesz ją zainstalować i uruchomić ponownie?",
