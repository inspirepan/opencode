export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Dandelion",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Dandelion wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
